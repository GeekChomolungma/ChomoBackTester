"""
Grid search over st_vrb_enhanced's take-profit/stop-loss thresholds.
...
OUTPUT_DIR = Path("output/optimize/st_vrb_enhanced/profit_loss/zec")
...
PARAM_GRID = {
    "take_profit_pct": [round(0.01 * i, 2) for i in range(2, 21)],
    "stop_loss_pct": [round(0.01 * i, 2) for i in range(2, 11)],
}
